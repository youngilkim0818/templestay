...
const MY_REVIEWS = [
  {
    ...
    rating: 5,
            content: 'It was a really beautiful temple. The temple stay program was also substantial and the monks were kind. The early morning prayer time was particularly impressive.',
        ...
        {filteredReviews.length > 0 ? (
          ...
          <View className="flex-1 justify-center items-center py-20">
            ...
            <Text className="text-lg font-semibold text-neutral-900 mt-4 mb-2">
              {filter === 'all' ? 'No reviews written yet' : 'No recommended reviews'}
            </Text>
            <Text className="text-sm text-neutral-600 text-center">
              {filter === 'all' 
                ? 'Write your first review!' 
                : 'No recommended reviews available.'
              }
            </Text>
