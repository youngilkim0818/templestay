                    ...
                    <View className="px-6 py-8">
                        ...
                        <View className="bg-white rounded-xl border border-gray-200 overflow-hidden mb-8">
                            ...
                            <View className="p-6 border-b border-gray-100">
                                <Text className="text-lg font-semibold text-neutral-900 mb-3">현재 비밀번호</Text>
                            ...
                            {/* 새 비밀번호 */}
                            <View className="p-6 border-b border-gray-100">
                                <Text className="text-lg font-semibold text-neutral-900 mb-3">새 비밀번호</Text>
                            ...
                            {/* 새 비밀번호 확인 */}
                            <View className="p-6">
                                <Text className="text-lg font-semibold text-neutral-900 mb-3">새 비밀번호 확인</Text>
                                <View className={`bg-white rounded-4xl p-4 border-2 ${confirmPasswordError ? 'border-red-500' : 'border-stone-200'} ${!passwordStrength.isComplete ? 'opacity-50' : ''}`} style={{ height: 60 }}>
                                    <TextInput
                                        className="flex-1 text-lg pr-12 pt-0"
                                        placeholder={passwordStrength.isComplete ? "새 비밀번호를 다시 입력하세요" : "비밀번호 요구사항을 먼저 완성하세요"}
                                        placeholderTextColor="#9CA3AF"
                        ...
                        {/* 변경하기 버튼 */}
                        <TouchableOpacity 
                            className="bg-sage-600 py-4 rounded-xl items-center"
                            onPress={handleChangePassword}
                        >
                            <Text className="text-white text-lg font-semibold">비밀번호 변경하기</Text>
                        </TouchableOpacity>
                    </View>
                </ScrollView>
            </KeyboardAvoidingView>
