...
const ReservationPaymentScreen = ({ navigation, route }: ReservationPaymentScreenProps) => {
  ...
  const handleComplete = () => {
    Alert.alert(
      '예약이 완료되었습니다!', 
              'Reservation confirmation message has been sent.\nHave a wonderful temple stay!', 
      [
            {
              text: '확인',
              onPress: () => {
          ...
          <View className="flex-row items-center mb-5">
            ...
            <View className="flex-1">
              <Text className="text-xl font-bold text-sage-600 mb-1">
                {reservation?.programTitle || reservation?.temple_programs?.title || 'Temple Stay'}
              </Text>
          ...
          <View className="space-y-4">
            <View className="flex-row items-center">
              ...
              <View className="flex-1 ml-3">
                <Text className="text-sm text-neutral-600 mb-0.5">Bulguksa Temple Stay</Text>
