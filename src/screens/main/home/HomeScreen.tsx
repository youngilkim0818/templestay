          ...
          <View className="px-0">
            ...
            <View className="mt-5 bg-[#FFFDF8] rounded-2xl px-4 py-2.5 border border-stone-200">
              <View className="flex-row items-center">
                ...
                <TextInput
                  placeholder="temple/region search"
                  ...
                  <View className="space-y-2">
                    <View className="flex-row items-center">
                      ...
                      <View className="flex-1">
                        ...
                        <Text className="text-xs text-neutral-600">Bulguksa Temple Stay was really great!</Text>
                      </View>
                    </View>
              ...
              <View className="mt-8 -ml-6">
                ...
                <View className="mb-4">
                  <Text className="text-xs text-neutral-500 leading-4">
                    Temple Stay acts as a communication sales intermediary and is not the party to the communication sales. The obligations and responsibilities related to product reservations, use, and refunds belong to each seller.
                  </Text>
                </View>
